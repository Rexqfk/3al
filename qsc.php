...
$headers[] = 'X-Location: -6.405821,106.064193';
        ...
        echo "--------------------------------------------------\n";
        echo "|                SCRIPT BY NONE                  |\n";
        echo "|            Komunitas Tumbuh Bersama            |\n";
        echo "|     https://github.com/Rexqfk/3al              |\n";
        echo "|   SCRIPT GOJEK AUTO REGIST + AUTO SAVE TOKEN   |\n";
        echo "|                    GOODLUCK                    |\n";
        echo "--------------------------------------------------\n";
        echo "\n";
        ulang:
        ...
        if($regs->success == true) {
            ...
            if($verifs->success == true) {
                ...
                // SANTAI19
                echo "[!] Proses Reedem Voucher 20+10 : GOFOODSANTAI19 \n";
                ...
                if($claims->success == true) 
                        {
                        ...
                        else 
                            {
                                echo "[×] Gagal Claim Voucer !";
                                    ...
                                    // SANTAI11
                                        echo "[!] Proses Reedem Voucher 15+10 : GOFOODSANTAI11 \n";
                                        ...
                                        if($claims1->success == true) 
                                                {
                                                ...
                                                } else 
                                                    {
                                                        echo "[×] Gagal Claim Voucer !";
                                                            ...
                                                            // SANTAI08
                                                                echo "[!] Proses Redeem Voucher 10+10 : GOFOODSANTAI08 \n";
                ...
                sleep(5);
                echo "\n";
                echo "[!] Proses Redeem Vocher : COBAINGOJEK \n";
                ...
                sleep(5);
                echo "\n";
                echo "[+] Proses Redeem Vocher : AYOCOBAGOJEK \n";
